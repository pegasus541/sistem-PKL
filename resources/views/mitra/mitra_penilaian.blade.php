        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">  
                        <form method="POST" action="{{ route ('form-nilaiutsmitra') }}">
                            @csrf
                            ...
                            <div class="form-group">
                                <label for="nilai_uts_mitra">Nilai UTS</label>
                                <input type="number" class="form-control" name="nilai_uts_mitra" id="nilai_uts_mitra" required>
                            </div>
        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">  
                        <form method="POST" action="{{ route ('form-nilaiuasmitra') }}">
                            @csrf
                            ...
                            <div class="form-group">
                                <label for="nilai_uas_mitra">Nilai UTS</label>
                                <input type="number" class="form-control" name="nilai_uas_mitra" id="nilai_uas_mitra" required>
                            </div>
